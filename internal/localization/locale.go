...
const languageOverrideEnvironment = "BREWTIFYER_LANGUAGE"

// DetectedLanguages returns normalized language preferences in priority order.
// BREWTIFYER_LANGUAGE takes precedence to make the selection explicit and
// deterministic for users, tests, and support.
